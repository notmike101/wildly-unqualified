...
function body(request: IncomingMessage, max: number): Promise<Buffer> {
...
async function fields(request: IncomingMessage, names: string[]) {
...
function safePath(request: IncomingMessage) {
  let path: string;
  try {
